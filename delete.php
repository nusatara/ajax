		...
		<div class="row">
          ...
          <div class="panel panel-danger">
            <div class="panel-heading">
              <h3 class="panel-title">Hapus Data Peserta</h3>
            </div>
            <!-- /.panel-header -->
            <!-- form start -->
            <form class="form-horizontal"  action="php_code/action_t_client.php?action=delete" method="POST">
              <div class="panel-body">
               ...
               <div class="form-group">
                ...
                <div class="btn-group pull-right">
                  <button type="submit" class="btn btn-danger" ><li class="fa fa-trash"></li> Hapus</button>
