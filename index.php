...
<body style="margin: 50px auto;">
			...
			<div class="col-xs-12">
				...
				<div class="panel panel-primary">
	                ...
	                <div class="panel-body">
						...
						<table id="tabel_data_client" class="table table-bordered table-striped">
							<thead>
								<tr>
									<th>Id</th>
	...
	<script type="text/javascript">
		var t = $('#tabel_data_client').DataTable({
				  "autoWidth": false,
				  "rowCallback": function( row, data, index ) {
					  $('td:eq(9)', row).html("<div class=\"btn-group\"><button class=\"btn btn-warning\" onClick=\"window.open('update.php?id_client="+data[0]+"','_self')\"><i class=\"fa fa-edit\"></i> Ubah</button>&nbsp;&nbsp;<button class=\"btn btn-danger\" onClick=\"window.open('delete.php?id_client="+data[0]+"','_self')\"><i class=\"fa fa-trash\"></i> Hapus</button></div>");
				  },			  
				  "columnDefs": [
	    				...
	    				{ "width": "10%", "sClass": "dt-head-center dt-body-left", "targets": 6 },
	    				{ "width": "10%", "sClass": "dt-head-center dt-body-left", "targets": 7 },
	    				{ "width": "10%", "sClass": "dt-head-center dt-body-left", "targets": 8 },
	    				{ "width": "20%", "sClass": "dt-head-center dt-body-center", "targets": 9 }
